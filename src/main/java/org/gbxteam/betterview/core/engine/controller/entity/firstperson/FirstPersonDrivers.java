...
import org.gbxteam.betterview.core.engine.motors.*;
...
public class FirstPersonDrivers {
    ...
    public static final DriverKey<SpringDriver<Vector3f>> CAMERA_ROTATION_DAMPING = DriverKey.of("camera_rotation_damping", () -> SpringDriver.ofVector3f(BFPMain.CONFIG.data().firstPersonPlayer.cameraRotationStiffnessFactor, BFPMain.CONFIG.data().firstPersonPlayer.cameraRotationDampingFactor, 1f, Vector3f::new, true));
    ...
    // BFP Frame-Drop Fix: Smooths out drastic speed drops caused by single-frame lag spikes
    public static final DriverKey<SpringDriver<Float>> SMOOTHED_WALK_SPEED = DriverKey.of("smoothed_walk_speed", () -> SpringDriver.ofFloat(0.6f, 0.4f, 1f, () -> 0f, true));
