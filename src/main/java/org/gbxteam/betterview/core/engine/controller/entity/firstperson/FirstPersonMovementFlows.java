...
public class FirstPersonMovementFlows {
    ...
    private static Identifier makeIdentifier(String path) {
        return Identifier.fromNamespaceAndPath(BFPMain.MOD_ID, "sequences/entity/player/first_person/".concat(path).concat(".json"));
    }
}