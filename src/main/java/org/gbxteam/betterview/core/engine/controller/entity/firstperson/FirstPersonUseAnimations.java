...
import org.gbxteam.betterview.core.engine.motors.TriggerDriver;
...
public class FirstPersonUseAnimations {
    ...
    public static final Identifier DEFAULT = register(BFPMain.makeIdentifier("default"), UseAnimationRule.of(
            FirstPersonMontages::getUseAnimationMontage,
            UseAnimationConditionContext::swingFromClient,
            0
    ));
    public static final Identifier PLACE_BLOCK = register(BFPMain.makeIdentifier("place_block"), UseAnimationRule.of(
            FirstPersonMontages::getPlaceBlockAnimationMontage,
            FirstPersonUseAnimations::shouldPlayPlaceBlock,
            5
    ));
    public static final Identifier AXE_SCRAPE = register(BFPMain.makeIdentifier("axe_scrape"), UseAnimationRule.of(
            FirstPersonMontages::getAxeScrapeMontage,
            FirstPersonUseAnimations::shouldPlayAxeScrape,
            10
    ));
    public static final Identifier HOE_TILL = register(BFPMain.makeIdentifier("hoe_till"), UseAnimationRule.of(
            FirstPersonMontages::getHoeTillMontage,
            FirstPersonUseAnimations::shouldPlayHoeTill,
            20
    ));
    public static final Identifier SHOVEL_FLATTEN = register(BFPMain.makeIdentifier("shovel_flatten"), UseAnimationRule.of(
            FirstPersonMontages::getShovelFlattenMontage,
            FirstPersonUseAnimations::shouldPlayShovelFlatten,
            30
    ));
    public static final Identifier SHEARS_USE = register(BFPMain.makeIdentifier("shears_use"), UseAnimationRule.of(
