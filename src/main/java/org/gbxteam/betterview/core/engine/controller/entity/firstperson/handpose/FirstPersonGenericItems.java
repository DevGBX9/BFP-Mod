...
//    public static final Identifier GENERIC_2D_ITEM = register(BFPMain.makeIdentifier("generic_2d_item"), GenericItemPoseDefinition.builder(
//            FirstPersonMovementFlows.HAND_GENERIC_ITEM_2D_ITEM_POSE,
//            itemStack -> true,
//            0)
//            .build());
    public static final Identifier FIXED_ITEM = register(BFPMain.makeIdentifier("fixed_item"), GenericItemPoseDefinition.builder(
                    FirstPersonMovementFlows.HAND_GENERIC_ITEM_FIXED_ITEM_POSE,
                    itemStack -> true,
                    0)
            .setItemRenderType(ItemRenderType.ON_SHELF)
            .build());
    public static final Identifier ROD = register(BFPMain.makeIdentifier("rod"), GenericItemPoseDefinition.builder(
            FirstPersonMovementFlows.HAND_GENERIC_ITEM_ROD_POSE,
            FirstPersonGenericItems::isRodItem,
            20)
            .build());
    public static final Identifier SHEARS = register(BFPMain.makeIdentifier("shears"), GenericItemPoseDefinition.builder(
            FirstPersonMovementFlows.HAND_GENERIC_ITEM_SHEARS_POSE,
            FirstPersonGenericItems::isShearsItem,
            60)
            .build());
    public static final Identifier FISHING_ROD = register(BFPMain.makeIdentifier("fishing_rod"), GenericItemPoseDefinition.builder(
            FirstPersonMovementFlows.HAND_GENERIC_ITEM_FISHING_ROD_POSE,
            FirstPersonGenericItems::isFishingRodItem,
            70)
            .build());
    public static final Identifier ARROW = register(BFPMain.makeIdentifier("arrow"), GenericItemPoseDefinition.builder(
            FirstPersonMovementFlows.HAND_GENERIC_ITEM_ARROW_POSE,
            FirstPersonGenericItems::isArrowItem,
            80)
            .setItemRenderType(ItemRenderType.MIRRORED_THIRD_PERSON_ITEM)
            .build());
//    public static final Identifier BLOCK = register(BFPMain.makeIdentifier("block"), GenericItemPoseDefinition.builder(
//                    FirstPersonMovementFlows.HAND_GENERIC_ITEM_BLOCK_POSE,
//                    FirstPersonGenericItems::isBlockItem,
//                    80)
//            .setItemRenderType(ItemRenderType.BLOCK_STATE)
//            .build());
//    public static final Identifier DOOR = register(BFPMain.makeIdentifier("door"), GenericItemPoseDefinition.builder(
//                    FirstPersonMovementFlows.HAND_GENERIC_ITEM_DOOR_BLOCK_POSE,
...
//            .build());
    ...
    public record GenericItemPoseDefinition(
        ...
        public static Builder builder(
                Identifier basePoseMovementFlow,
                Predicate<ItemStack> choosePoseIfTrue,
                int evaluationPriority
        ) {
            return new Builder(basePoseMovementFlow, choosePoseIfTrue, evaluationPriority);
        }

        public static class Builder {

            private final Identifier basePoseMovementFlow;
            ...
            private Builder(
                ...
                this.basePoseMovementFlow = basePoseMovementFlow;
...
//    }
    ...
    public static PoseFunction<LocalSpacePose> constructPoseFunction(CachedPoseContainer cachedPoseContainer, InteractionHand hand, PoseFunction<LocalSpacePose> miningPoseFunction) {
        ...
        consumablePose = SequenceEvaluatorFunction.builder(FirstPersonMovementFlows.HAND_GENERIC_ITEM_2D_ITEM_POSE).build();
        ...
        pose = ApplyAdditiveFunction.of(
                ...
                MakeDynamicAdditiveFunction.of(
                        consumablePose,
                        SequenceEvaluatorFunction.builder(FirstPersonMovementFlows.HAND_GENERIC_ITEM_2D_ITEM_POSE).build()
                )
        );
