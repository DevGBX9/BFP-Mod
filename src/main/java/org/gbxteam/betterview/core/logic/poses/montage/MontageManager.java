...
public class MontageManager {
    ...
    public LocalSpacePose getLayeredSlotPose(LocalSpacePose basePose, String slot, RigSystem jointSkeleton, float partialTicks) {
...
//                slotPose = slotPose.interpolated(montageInstance.getPose(jointSkeleton, partialTicks), montageInstance.getWeight(partialTicks), null, null);
    ...
    private static class MontageInstance {
        ...
        private MontageInstance(MontageConfiguration configuration, DriverGetter driverGetter) {
            ...
            this.tickLength = BFPResources.getOrThrowMovementFlow(configuration.animationSequence()).length().inTicks();
        ...
        private LocalSpacePose getPose(RigSystem jointSkeleton, float partialTicks) {
            ...
            if (this.configuration.isAdditive()) {
                ...
                if (this.additiveBasePose == null) {
                    this.additiveBasePose = MovementFlow.samplePose(
                            jointSkeleton,
                ...
                if (this.additiveSubtractionPose == null) {
                    ...
                    MovementFlow sequence = BFPResources.getOrThrowMovementFlow(sequenceLocation);
