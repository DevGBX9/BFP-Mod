...
public class LocalSpacePose extends Pose {
    ...
    private LocalSpacePose(RigSystem jointSkeleton) {
        super(jointSkeleton);
    }
     ...
     */
    public static LocalSpacePose of(RigSystem jointSkeleton) {
    ...
    public ComponentSpacePose convertedToComponentSpace() {
        ...
        pose.convertChildrenJointsToComponentSpace(this.getRigSystem().getRootJoint(), new PoseStack());
        return pose;
    }
    ...
    public LocalSpacePose mirrored() {
        ...
        this.jointChannels.keySet().forEach(joint -> {
            RigSystem.JointConfiguration configuration = this.getRigSystem().getJointConfiguration(joint);
