...
public abstract class Pose {
    ...
    protected final RigSystem jointSkeleton;
    ...
    protected Pose (RigSystem jointSkeleton) {
    ...
    protected void convertChildrenJointsToComponentSpace(String parent, PoseStack poseStack){
        ...
        this.getRigSystem().getDirectChildrenOfJoint(parent).forEach(child -> this.convertChildrenJointsToComponentSpace(child, poseStack));
    ...
    protected void convertChildrenJointsToLocalSpace(String parent, Matrix4f parentMatrix){
        ...
        this.getRigSystem().getDirectChildrenOfJoint(parent).forEach(child -> this.convertChildrenJointsToLocalSpace(child, this.jointParentMatrices.get(parent)));
