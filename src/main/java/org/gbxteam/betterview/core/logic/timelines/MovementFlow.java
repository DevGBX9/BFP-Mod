package org.gbxteam.betterview.core.logic.timelines;
...
public record MovementFlow(
     ...
     */
    public static LocalSpacePose samplePose(RigSystem jointSkeleton, Identifier sequenceLocation, TimeSpan time, boolean looping) {
        MovementFlow animationSequence = BFPResources.getOrThrowMovementFlow(sequenceLocation);
    ...
    public MovementFlow getBaked() {
        Builder bakedSequenceBuilder = MovementFlow.builder(this.length, this.jointSkeletonLocation);
        RigSystem jointSkeleton = BFPResources.getOrThrowRigSystem(this.jointSkeletonLocation);
        for (String joint : jointSkeleton.getJoints()) {
    ...
    public static class Builder {
        ...
        public MovementFlow build() {
            return new MovementFlow(
