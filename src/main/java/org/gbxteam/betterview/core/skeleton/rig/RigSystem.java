...
public class RigSystem {
    ...
    private static final Logger LOGGER = LogManager.getLogger("BFP.RigSystem");
    ...
    private RigSystem(Map<String, JointConfiguration> joints, String rootJoint, Map<String, Float> customAttributeDefaults){
        this.joints = joints;
     ...
     */
    public static RigSystem.Builder of(String rootJoint) {
        return new RigSystem.Builder(rootJoint);
    }
    ...
    public static class Builder {
        ...
        public RigSystem build(){
            HashMap<String, JointConfiguration> jointsBuilt = Maps.newHashMap();
            return new RigSystem(this.joints, this.rootJoint, this.customAttributeDefaults);
        }
    }
